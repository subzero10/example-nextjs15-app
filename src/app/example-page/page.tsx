...
class HBExampleFrontendError extends Error {
  constructor(message: string | undefined) {
    super(message);
    this.name = "HBExampleFrontendError";
  }
}
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Test HB for your Next.js app!" />
      </Head>
      ...
      <main>
        ...
        {hasSentError ? (
          <p className="success">
            Sample error was sent to Honeybadger.
          </p>
        ) : (
